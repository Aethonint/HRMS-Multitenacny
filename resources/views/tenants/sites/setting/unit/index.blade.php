...
<a href="#" 
   class="btn btn-lg btn-half-white" 
...
<div class="modal fade" id="addDepartmentModal" tabindex="-1" aria-labelledby="addDepartmentLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered"> <!-- Centered Modal -->
    <div class="modal-content rounded-5 shadow-lg"> <!-- Rounded corners here -->
      ...
      <div class="modal-body">
        <form id="addDepartmentForm" method="POST" action="{{ route('departments.store') }}">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control rounded-3" id="departmentName" name="name" required>
          </div>
        </form>
      </div>
      ...
      <div class="modal-footer justify-content-between border-0">
        ...
        <button type="submit" form="addDepartmentForm" class="btn btn-primary rounded-3 px-4">Submit</button>
      </div>
                                        ...
                                        <div class="body">
                                              <!-- Example row -->
   <!-- Department Row -->
<div class="dept-row d-flex justify-content-between align-items-center border rounded p-3 mb-2 bg-white">
...
<div class="dept-row d-flex justify-content-between align-items-center border rounded p-3 mb-2 bg-white">
    ...
    .profile-tab-box .nav .nav-link.active {
        color: rgb(0, 0, 0) !important;              /* text red */
         border-bottom:4px solid #226FBA;   /* blue bottom line */
